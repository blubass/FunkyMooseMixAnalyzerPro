...
- **Auto Master**: optional off-by-default processing with strength, target LUFS, ceiling, gain, tone-shaping, stereo width, glue-compression, limiter-reduction, and loudness-match preview readouts
