...
def plugin_report_to_analysis(report, req_id):
    ...
    summary = {
        ...
        "auto_master": {
            ...
            "projected_lufs": rounded_number(auto_master_payload.get("projectedLufs"), 2),
            "projected_true_peak_dbtp": rounded_number(auto_master_payload.get("projectedTruePeakDbTp"), 2),
            "loudness_match_gain_db": rounded_number(auto_master_payload.get("loudnessMatchGainDb"), 2),
            "lufs_delta_db": rounded_number(auto_master_payload.get("lufsDeltaDb"), 2),
            "true_peak_margin_db": rounded_number(auto_master_payload.get("truePeakMarginDb"), 2),
            "release_score": rounded_number(auto_master_payload.get("releaseScore"), 1),
            "ab_loudness_delta_db": rounded_number(auto_master_payload.get("abLoudnessDeltaDb"), 2),
            "ab_true_peak_dbtp": rounded_number(auto_master_payload.get("abTruePeakDbTp"), 2),
            ...
            "governor_risk_score": rounded_number(auto_master_payload.get("governorRiskScore"), 1),
