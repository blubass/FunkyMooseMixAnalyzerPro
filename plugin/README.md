...
- Optional Auto Master applies conservative genre-aware loudness gain, low/presence/air tone shaping, stereo safety, and a -1.0 dBTP output guard.
...
- Copy report now includes a Mix Doctor Summary, worst-case holds, Auto Master moves, delivery preview, reference/A-B notes, and band-phase readouts.
...
spectral band routing, Auto Master bypass/leveling behaviour, and DAW state
